      ...
      <Page size="A4" style={s.page}>
        ...
        <View style={s.disclaimer}>
          <Text style={s.disclaimerText}>
            This analysis follows commonly accepted Vaastu Shastra principles and is for informational purposes only.
            Different Vaastu traditions may offer different guidance. Generated by My Vaastu Pandit.
          </Text>
        </View>
